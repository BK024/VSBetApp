...
@app.route("/about")
def about():
    return "A Python WebApp for tracking bets regarding the 2020 USA presidential elections.<br>Build by BK024.<br>For the source code look at {}".format(make_link("https://github.com/BK024/VSBetApp", "my GitHub account."))
